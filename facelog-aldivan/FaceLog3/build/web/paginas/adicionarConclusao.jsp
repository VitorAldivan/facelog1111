...
<%
    ...
    // Recuperar os dados do relatório com base no ID
    try {
...
<head>
    ...
    <title>Adicionar Conclusão</title>
    ...
    <main>
        <div class="main-container">
            ...
            <div class="menu-relatorio">
                <h2 class="nome-menu">Adicionar Conclusão<hr class="blue-line"></h2>
                <form method="POST" action="processarConclusao.jsp">
                    <div class="div-status">
                        <h3 class="titulo">Título:<br><p id="titulo"><%= titulo != null && !titulo.trim().isEmpty() ? titulo : "Não encontrado" %></p></h3>
                    </div>
                    ...
                    <br>
                    <h3 class="descricao-resolucao">Descrição da resolução do erro:<br><br><textarea name="descricaoResolucao" type="text" id="resolucao-erro"></textarea></h3>
                    <br>
                    <div class="linha-1-relatorio">
                        <h3 class="codigo">Código de Identificação:<p id="codigo"><%= id %></p><h3>
                        <h3 class="inicio-incidente">Início do Incidente:<br><p type="date" id="inicio-incidente"><%= inicioIncidente != null && !inicioIncidente.trim().isEmpty() ? inicioIncidente : "Não encontrado" %></p></h3>
